    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#FA2A55] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-rose-950/30 font-sans">
              {personalInfo.brandName}<span className="text-rose-950/30">.</span>
            </div>
