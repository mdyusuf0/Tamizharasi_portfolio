  ...
  useEffect(() => {
    ...
    class Particle {
      constructor(x, y, dx, dy) {
        ...
        const colors = [
          'rgba(250, 42, 85, ',  // Red Pink (#FA2A55)
      ...
      draw() {
        ...
        ctx.shadowBlur = 4;
        ctx.shadowColor = 'rgba(250, 42, 85, 0.4)';
        ctx.fill();
        ctx.restore();
      }
    }
    ...
    const animate = () => {
      ...
      if (mouse.active) {
        ...
        gradient.addColorStop(0, 'rgba(250, 42, 85, 0.08)');
        gradient.addColorStop(0.5, 'rgba(251, 113, 133, 0.03)');
