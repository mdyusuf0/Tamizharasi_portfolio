...
const Hero = ({ onVideoLoaded }) => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      {/* Background Poster - Displays immediately, positioned at 100% to place the girl on the left */}
      <div 
      ...
      {/* Background Video - Smoothly fades in once loaded, positioned at 100% */}
      <video
        ref={videoRef}
        loop
        muted={isMuted}
